...
def sandpuma_test(shuffle, jackknife, testfaa, trainfaa, trainaln, trainnwk, trainrefpkg):
    ...
    jackknife_data = data_dir+'sandpuma2_jkdata.tsv'
    ref_aln = trainaln
...
data_dir = os.path.dirname(os.path.realpath(sys.argv[0]))+'/data/'
xval_sandpuma( fasta.read_fasta(data_dir+'fullset0_smiles.faa'),
               data_dir+'sandpuma2_jkdata.tsv',
               data_dir+'fullset0_smiles.nncodes.tsv'
)
